...
export default function SignupPage() {
  ...
  const handleSignup = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const communityCode = (form.elements.namedItem('community-code') as HTMLInputElement).value;
    ...
    try {
      ...
      const newUser: NewReferredUser = {
        ...
        leg,
        referredBy: communityCode || undefined
      };
            ...
            <form onSubmit={handleSignup} className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Input id="password" type={showPassword ? 'text' : 'password'} required disabled={isSubmitting} />
                  <Button
                    type="button"
                    variant="ghost"
                    size="icon"
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Input id="confirm-password" type={showConfirmPassword ? 'text' : 'password'} required disabled={isSubmitting} />
                  <Button
                    type="button"
                    variant="ghost"
                    size="icon"
               ...
               <div className="space-y-2">
                <Label htmlFor="community-code">Community Code (Optional)</Label>
                <Input id="community-code" type="text" placeholder="Enter code from a friend" disabled={isSubmitting} />
              </div>
