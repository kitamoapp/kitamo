...
export const FinancialOpportunitySchema = z.object({
    ...
    action: z.string().optional().describe("A short call-to-action label for a button, like 'See Details' or 'Generate Script'."),
});
...
const prompt = ai.definePrompt({
  ...
  prompt: `
    ...
    -   **Income**: Suggest a Filipino-centric side-hustle ('raket'). Could be related to online work, local services, etc. Keep it general but inspiring.
