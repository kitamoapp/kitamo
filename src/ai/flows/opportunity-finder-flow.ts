...
const FinancialOpportunitySchema = z.object({
    ...
    action: z.string().optional().describe("A short call-to-action label for a button, like 'See Details' or 'Go to Referrals'."),
});
...
const prompt = ai.definePrompt({
  ...
  prompt: `
    ...
    -   **Income**: If the user's income seems low or their expenses are high, suggest they use the app's built-in referral system to earn extra money. Frame this as a core feature of the app for earning. Give it an action of "Go to Referrals".
