...
export const allFeatures: SubscriptionFeature[] = [
  ...
  { text: 'Earn rewards by growing the community', id: 'referral_system' },
  { text: '40% bonus on matched volume', id: 'commission_40' },
  { text: '60% bonus on matched volume', id: 'commission_60' },
  { text: '85% bonus on matched volume', id: 'commission_85' },
