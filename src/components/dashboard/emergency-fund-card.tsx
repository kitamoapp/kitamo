...
export function EmergencyFundCard() {
  ...
  const renderIcon = () => {
    switch (status) {
        case 'onTrack': return <ShieldCheck className="h-6 w-6 text-green-500" />;
        case 'atRisk': return <ShieldAlert className="h-6 w-6 text-amber-500" />;
        case 'noData': return <PiggyBank className="h-6 w-6 text-primary" />;
        default: return <Loader2 className="h-6 w-6 animate-spin" />;
    }
  }
